...
//#endif
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		model1 = glm::translate(model1, glm::vec3(posX + -0.6f, posY, posZ));

		if (rotateX)
    		model1 = glm::rotate(model1, angle, glm::vec3(1,0,0));
		if (rotateY)
    		model1 = glm::rotate(model1, angle, glm::vec3(0,1,0));
		if (rotateZ)
		...
		model2 = glm::translate(model2, glm::vec3(posX + 0.6f, posY, posZ));
		...
		if (rotateZ)
    		model2 = glm::rotate(model2, angle, glm::vec3(0,0,1));
...
int setupGeometry()
{
	...
	GLfloat vertices[] = {
    // CUBO - 6 faces, cada uma com cor diferente
